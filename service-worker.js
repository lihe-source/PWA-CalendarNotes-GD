const CACHE='calendar-notes-pwa-v1.0.0';
const CORE=['./','./index.html','./style.css','./config.js','./app.js','./db.js','./api.js','./google-drive.js','./push.js','./manifest.json','./version.json','./icon-192.png','./icon-512.png'];
